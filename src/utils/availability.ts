...
export const waitOptions = {
  wait: z
    ...
    .default(true)
    .describe(
      "Wait until the published version is available for use (use --no-wait to return as soon as the publish is submitted)",
    ),
  "wait-timeout": z.coerce
    ...
    .describe("Seconds to wait for the published version to become available"),
};
