...
const nativeFieldSchemas = {
  ...
  isCommonTrigger: z.boolean(),
  isPollingTrigger: z.boolean(),
  ...
  isReplay: z.boolean(),
  isLoopStep: z.boolean(),
  versionNumber: z.number().int(),
  componentVersion: z.number().int(),
  durationMs: z.number().int(),
  stepCount: z.number().int(),
  retryAttemptNumber: z.number().int(),
  loopStepIndex: z.number().int(),
  loopIterationCount: z.number().int(),
