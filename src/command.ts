...
import { type Cli, Errors, middleware, z } from "incur";
import { createCommandContext } from "./command-context.js";
import { environmentOptions, globalOptions } from "./command-schemas.js";
import {
    ...
    const local = {
      ...
      runtime: {
        ...
        authSession: createCommandContext({
          environment: execution.runtime.environment,
          profileName: execution.runtime.selectedProfile || undefined,
          profileOnly: execution.runtime.profileOnly,
        }),
      },
    };
