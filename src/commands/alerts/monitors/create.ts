...
export default Cli.command({
  ...
  hint: "Use alerts groups list, instances list, and alerts triggers list to find IDs for the example.",
  examples: [
    {
      description:
      ...
      options: {
        ...
        triggers: JSON.stringify(["TRIGGER_ID"]),
        duration: 10,
        groups: JSON.stringify(["ALERT_GROUP_ID"]),
      },
    },
  ],
  options: z.object({
