...
const topicDescriptions: Record<string, string> = {
  ...
  components: "Explore, create, and publish Components",
  "components:actions": "Explore the Actions a Component provides",
  "components:connections": "Explore the Connections a Component provides",
  "components:data-sources": "Explore the Data Sources a Component provides",
  "components:dev": "Component development utilities",
  "components:init": "Create Components",
  "components:triggers": "Explore the Triggers a Component provides",
  customers: "Manage Customers",
  "customers:users": "Manage Customer Users",
  executions: "Search executions and inspect their steps, logs, and payloads",
